...
<body class="d-flex align-items-center justify-content-center min-vh-100 bg-light"> 
    <div class="form-container">
        <div class="back-button-container">
                ...
                <h2 class="fs-3 fw-bold mb-0">Edit Data Customer</h2> 
            </div>
        ...
        <form action="<?php echo e(route('customers.update', $customer->id)); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_cust" id="nama_cust" class="form-control" value="<?php echo e(old('nama_cust', $customer->nama_cust)); ?>">
            </div>
            <div class="mb-3">
                <label for="alamat_cust" class="form-label fw-semibold">Alamat</label>
                <input type="text" name="alamat_cust" id="alamat_cust" class="form-control" value="<?php echo e(old('alamat_cust', $customer->alamat_cust)); ?>">
            </div>
            <div class="mb-3">
                <label for="nomor_cust" class="form-label fw-semibold">No Handphone</label>
                <input type="text" name="nomor_cust" id="nomor_cust" class="form-control" value="<?php echo e(old('nomor_cust', $customer->nomor_cust)); ?>">
            </div>
            <div class="mb-4">
                <label for="tglmasuk_cust" class="form-label fw-semibold">Tanggal Masuk</label>
                <input type="date" name="tglmasuk_cust" id="tglmasuk_cust" class="form-control" value="<?php echo e(old('tglmasuk_cust', \Carbon\Carbon::parse($customer->tglmasuk_cust)->format('Y-m-d'))); ?>">
            </div>
            <div class="d-grid">
...
</html><?php /**PATH C:\laragon\www\LAUNDRY-IN_TIM_380_SI4601\resources\views/customers/edit.blade.php ENDPATH**/ ?>