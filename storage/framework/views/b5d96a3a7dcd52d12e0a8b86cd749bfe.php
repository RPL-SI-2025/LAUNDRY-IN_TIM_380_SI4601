...
<div class="background-container">
  <div class="container py-5 d-flex justify-content-center">
    <div class="form-wrapper bg-white p-5 rounded shadow" style="width: 100%; max-width: 600px;">
      ...
      <form action="<?php echo e(route('input.outlet.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nama_outlet" name="nama_outlet" 
                 value="<?php echo e(old('nama_outlet')); ?>"
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="alamat_outlet" name="alamat_outlet" 
                 value="<?php echo e(old('alamat_outlet')); ?>"
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="nomor_layanan" name="nomor_layanan" 
                 value="<?php echo e(old('nomor_layanan')); ?>"
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="layanan_laundry" name="layanan_laundry" 
                 value="<?php echo e(old('layanan_laundry')); ?>"
        ...
        <div class="mb-4">
          ...
          <textarea class="form-control" id="deskripsi_outlet" name="deskripsi_outlet" 
                    rows="3" placeholder="Jelaskan tentang outlet laundry Anda" required><?php echo e(old('deskripsi_outlet')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.appoutlet', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LAUNDRY-IN_TIM_380_SI4601\resources\views/admin/input-outlet.blade.php ENDPATH**/ ?>