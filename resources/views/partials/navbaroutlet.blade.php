<nav class="navbar navbar-expand-lg navbar-light bg-white px-4">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="{{ url('admin/homeoutlet') }}">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link fw-bold" href="{{ url('admin/homeoutlet') }}">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold" href="{{ url('input-outlet') }}">Input Outlet</a>
          </li>
          <li class="nav-item">
